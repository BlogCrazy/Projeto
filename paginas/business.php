		...
		<div class="col-md-9 technology-left">
			<div class="business">
				<div class="business-top">
					<div class="col-md-4 business-left">
						<h3>Web Solutions</h3>
						<p>Our broad tool-set enables us to partner with you to create and integrate custom solutions that streamline efficiency.</p>
					...
					<div class="col-md-4 business-left">
						...
						<p>Our digital marketing services will help you increase revenue, deepen relationships, enhance referrals, and elevate .</p>
					...
					<div class="col-md-4 business-left">
						...
						<p>Our proven approach will help you develop targeted growth strategies to multiply and measure the impact of your.</p>
							<li><a href="#">Vision Maps</a></li>
							<li><a href="#">C-Level Priorities</a></li>
							<li><a href="#">Content Strategies</a></li>
							<li><a href="#">Surveys and Personas</a></li>
							<li><a href="#">Integrated Marketing Plans</a></li>
							<li><a href="#">Technology Roadmaps</a></li>
							<li><a href="#">Brand / Identity Suite</a></li>
					</div>
				...
				<div class="business-bottom">
					...
					<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod consectetur adipisicing elit, sed do eiusmod tempor incididunt consectetur adipisicing elit, tempor incididunt sed do eiusmod tempor incididunt consectetur adipisicing elit, consectetur adipisicing elit,</p>
					<p>consectetur adipisicing elit, sed do eiusmod tempor incididunt consectetur consectetur adipisicing elit, sed do eiusmod tempor incididunt consectetur adipisicing elit,adipisicing elit, nsectetur adipisicing elit,</p>
					<p>consectetur adipisicing elit, sed do eiusmod consectetur adipisicing elit, sed do eiusmod tempor incididunt consectetur adipisicing elit, tempor incididunt consectetur adipisicing elit,</p>
